		...
		<ThemeProvider theme={theme}>
			...
			>
				<Container maxWidth="md">
							...
							<Grid item xs={12} sm={6} key={index}>
								<Card
									...
									sx={{
										...
										position: "relative",
										borderRadius: 3,
										bgcolor: option.recommended
											? alpha(theme.palette.primary.main, 0.1)
											: "background.paper",
										boxShadow: option.recommended
											? "0 8px 32px 0 rgba(66,133,244,0.18)"
											: undefined,
					...
					<Paper
						elevation={2}
						sx={{ p: { xs: 2, md: 4 }, mb: 4, borderRadius: 3 }}
					>
						<Typography
							variant="h5"
							gutterBottom
					...
					<Paper elevation={2} sx={{ p: { xs: 2, md: 4 }, borderRadius: 3 }}>
						...
						<Typography variant="body1" paragraph>
							Always verify the integrity of your download using the provided
							checksums. This ensures your ISO file hasn't been corrupted during
							download.
						</Typography>
						<Box
							sx={{
